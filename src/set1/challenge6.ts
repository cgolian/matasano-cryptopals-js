...
function calculatePotentialKeysizes(contents: Buffer): Keysize[] {
...
export function transposeBlocks(blocks: Buffer[], transposedCount: number): Buffer[] {
