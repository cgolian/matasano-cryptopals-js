...
export interface CtrEncryptionOracle {
    encryptCiphertextsWithFixedNonceAndRandomKey(): Buffer[];
}
...
export function createCtrEncryptionOracle(plaintexts: string[]): CtrEncryptionOracle {
    function ctrEncryptionOracle(): Buffer[] {
