...
*/
export const a1Constraints: EqualToConstraint[] = [
    ...Array(6).fill(null), 'b'
];
export const d1Constraints: EqualToConstraint[] = [
    ...Array(6).fill(null), '0', 'a', null, null, 'a'
];
export const c1Constraints: EqualToConstraint[] = [
    ...Array(6).fill(null), '1', '1', null, null, '0', ...Array(14).fill(null), 'd'
];
export const b1Constraints: EqualToConstraint[] = [
 ...
 */
export const a2Constraints: EqualToConstraint[] = [
    ...Array(7).fill(null), '1', null, null, '1', null, null, 'b',
];
export const d2Constraints: EqualToConstraint[] = [
    ...Array(13).fill(null), '0', null, null, null, null, 'a', 'a', 'a', 'a', null, null, null, '1'
];
export const c2Constraints: EqualToConstraint[] = [
    ...Array(12).fill(null), 'd', '0', 'd', null, null, null, 'c', '0', '1', '0'
];
export const b2Constraints: EqualToConstraint[] = [
 ...
 */
export const a4Constraints: EqualToConstraint[] = [
    ...Array(22).fill(null), '0', null, null, '0', 'b', null, 'b', '1', null, '0'
];
export const d4Constraints: EqualToConstraint[] = [
    ...Array(22).fill(null), '0', null, null, '0', '1', null, '1', '0', null, '1'
];
export const c4Constraints: EqualToConstraint[] = [
    ...Array(18).fill(null), 'd', null, null, null, '1', null, null, '1', '0', null, '0', '0'
];
export const b4Constraints: EqualToConstraint[] = [
 ...
 */
export const a5Constraints: EqualToConstraint[] = [
...
export function applyDifferential(msg: number[]): number[] {
